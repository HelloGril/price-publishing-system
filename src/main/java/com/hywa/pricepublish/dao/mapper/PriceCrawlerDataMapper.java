...
public interface PriceCrawlerDataMapper {
    ...
    int updateByExampleSelective(@Param("record") PriceCrawlerData record, @Param("example") PriceCrawlerDataExample example);

    int updateByExample(@Param("record") PriceCrawlerData record, @Param("example") PriceCrawlerDataExample example);
