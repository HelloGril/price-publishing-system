...
public class PermissionAuthConfig {
    ...
    public Object executeAround(ProceedingJoinPoint point) throws Throwable {
        ...
        if (isHasPermission(realMethod, userId)) {
            ...
            responseBase.setRetHead(ConstantPool.FAILURE, "Not allowed to pass, you do not have the authority");
            outputStream.write(new ObjectMapper().writeValueAsString(responseBase).getBytes("UTF-8"));
        }
        return obj;
    }
